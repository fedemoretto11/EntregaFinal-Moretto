...
function ItemListContainer() {
  ...
  // Aca la idea es en realidad usar la api de Meli, ahora lo dejo comentado porque no logre resolver un temita que creo que lo vamos a ver mas adelante en clase
  ...
  const fetchSimulado = () => {
    const peticionProductos = new Promise((res,rej) => {
      setTimeout(() => {
        res(productsApi)
      },1000)
    })
    return peticionProductos;
  }
  ...
  useEffect(()=> {
    ...
    fetchSimulado()
      ...
      .catch(new Error("Error falla mistake"))
